...
@MainActor public class QuickPuzzlePieceSectionLayout {
    ...
    public internal(set) weak var parentLayout: QuickPuzzleCollectionViewLayout?
...
extension QuickPuzzlePieceSectionLayout {
     ...
     */
    public var invalidationContext: QuickPuzzleCollectionViewLayoutInvalidationContext? {
        guard let _ = parentLayout else { return nil }
        
        return QuickPuzzleCollectionViewLayoutInvalidationContext()
    }
